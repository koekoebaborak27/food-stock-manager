...
| 項目 | 状態 |
| --- | --- |
| 作業ブランチ | `main`（タスク7b・7c・7d-1〜7d-5・7e-1〜7e-5・7f-1・7f-2のPRはすべてマージ済み）。`codex/notification-settings-screen`（7f-3、[PR #27](https://github.com/koekoebaborak27/food-stock-manager/pull/27)、マージ未指示） |
